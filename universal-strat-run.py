...
# =============================================
# ⚙️ User input for SYMBOL
# =============================================
SYMBOL = input("📈 Enter the stock symbol you want to trade (e.g., AAPL): ").strip().upper()
POSITION_SIZE = 25
...
# 🔁 LIVE HFT Loop
# =============================================
print(f"🚀 Starting DAILY HFT Scalping Strategy for {SYMBOL} with final AUDIT log save")
